...
class StreamBufferEraseRequest:
    ...
    def validate(self) -> None:
        ...
        if self.buffer_number is None:
            raise ValueError(f'Property "BufferNumber" of "StreamBufferEraseRequest" is None.')

        if not isinstance(self.buffer_number, (int, float, decimal.Decimal)):
            raise ValueError(f'Property "BufferNumber" of "StreamBufferEraseRequest" is not a number.')

        if int(self.buffer_number) != self.buffer_number:
            raise ValueError(f'Property "BufferNumber" of "StreamBufferEraseRequest" is not integer value.')
