"""This is a pysweepme example with the Logger_DeviceClass-template.

It shows how one can make an instance of a driver with
...
port_string = ""  # not needed here, otherwise "COM1" or "GPIB0::1::INSTR")
